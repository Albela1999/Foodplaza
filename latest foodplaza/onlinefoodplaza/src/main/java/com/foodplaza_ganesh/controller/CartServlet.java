...
public class CartServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	    ...
	    try {
	        ...
	        // Check if totalprice parameter is not null before parsing
	        String totalpriceParameter = req.getParameter("totalprice");
	        double totalprice = totalpriceParameter != null ? Double.parseDouble(totalpriceParameter) : 0.0;
